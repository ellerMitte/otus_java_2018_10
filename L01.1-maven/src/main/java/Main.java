 ...
 * mvn package
 * java -cp ./target/L01.1-maven.jar ellermitte.Main
 * java -jar ./target/L01.1-maven.jar //java.lang.NoClassDefFoundError: com/google/common/collect/Lists
 * java -cp ./target/L01.1-maven.jar;C:\Users\vitaly.chibrikov\.m2\repository\com\google\guava\guava\23.0\guava-23.0.jar ellermitte.Main
 *
 * To unzip the jar:
